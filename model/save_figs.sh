...
python draw_hist.py --dates 1105 1217 0108 0109 --view F --axis z --mode original
...
python draw_hist.py --dates 0109 --view F --axis z --mode original
python draw_hist.py --dates 0108 0109 --view F --axis z --mode original
